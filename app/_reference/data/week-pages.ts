  ...
  week1: {
    ...
    days: [
      ...
      },
      {
        ...
        date: "Nov 2 · Mon",
        tag: "Alibaba",
        hl: "Welcome, lightning intros, then inside Alibaba's model stack.",
        title: "Welcome & Alibaba",
        body: "Welcome meeting and lightning intros (3 minutes each), followed by a visit to Alibaba on its Tongyi Qianwen (Qwen) models, large-model stack, and cloud. Evening walk along Suzhou Creek.",
        badges: ["Alibaba", "Qwen"],
      },
      {
        n: "03",
        ...
        body: "ByteDance's Volcano Engine team on building AI infrastructure and short-drama production tools like Seedance.",
        badges: ["ByteDance", "Volcano Engine", "Seedance"],
      },
      {
        n: "04",
        img: "/reference/6c023b039a82749c.jpg",
        date: "Nov 4 · Wed",
        tag: "Foundation Model Center",
        hl: "Inside the model district, where consumer AI hardware meets daily life.",
        title: "Model District & Consumer AI Hardware",
        body: "A morning at the Shanghai Foundation Model Innovation Center, the model-innovation community anchored by MiniMax, exploring how consumer AI hardware is working its way into everyday work and life, including the Third Space and Zpilot. Then institute visits to the Shanghai Innovation Institute (sii.edu.cn) and HKUST's Shanghai center for exchange with PhD founders. Evening cycling along the riverside.",
        badges: ["Foundation Model Center", "Consumer AI Hardware", "SII"],
      },
      {
        n: "05",
        ...
        date: "Nov 5 · Thu",
        tag: "Ctrip",
        hl: "Ctrip's inbound-travel stack, then Hei Hu's AI factory floor.",
        title: "Travel Tech & Smart Manufacturing",
        body: "Ctrip on inbound travel and fintech products for international travelers, and a visit to Hei Hu Manufacturing to see how AI is digitizing the factory floor — real-time data across machines, lines, and supply chains.",
        badges: ["Ctrip", "Hei Hu Manufacturing"],
      },
      {
        n: "06",
        ...
        date: "Nov 6 · Fri",
        tag: "Sequoia",
        hl: "Roadshows with young builders, then the capital roundtable.",
        title: "Roadshows & the Capital Roundtable",
        body: "An afternoon at Sequoia China's Beiyang AI Town for project roadshows and matchmaking with PhD researchers and China's youngest AI builders, followed by a VC/PE roundtable on where foreign capital still has room to play in China's AI startup scene. Closing with a farewell dinner.",
        badges: ["Sequoia China", "VC/PE"],
      },
      {
        n: "07",
        img: "/reference/week1-closing-dinner.jpg",
        date: "Nov 7 · Sat",
        tag: "Closing & Onward Travel",
