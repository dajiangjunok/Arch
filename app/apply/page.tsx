    ...
    <main className="min-h-screen bg-ivory px-6 py-10 text-ink sm:px-10 lg:px-20">
      <div className="mx-auto max-w-[1120px]">
        <header className="flex items-start justify-between gap-6">
          ...
          <Link
            href="/"
            className="rounded-md border border-ink/25 px-4 py-3 font-mono text-[11px] uppercase tracking-[0.24em] text-ink transition hover:border-ink hover:bg-card"
          >
            Back Home
          </Link>
        </header>
        ...
        <section className="mt-14 grid gap-10 lg:grid-cols-[0.74fr_1fr] lg:items-start">
          <div className="lg:sticky lg:top-10">
            ...
            <p className="mt-8 max-w-xl text-sm leading-8 text-ink/72">
              Tell us who you are, which pass fits your schedule, and what you want to explore in Shanghai. Approved applicants
              receive dedicated payment instructions from The Arch. team.
            </p>
